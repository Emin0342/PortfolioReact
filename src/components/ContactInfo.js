...
const ContactInfo = ({ name, email, location }) => {
  ...
  return (
    ...
    >
      <h4 className="contentTitle">Me contacter</h4>
      <p className="infoDescription">Je suis ouvert à toutes nouvelles opportunités. Contactons-nous et construisons quelque chose de génial ensemble !</p>
